        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->Body    = 'Here is the verification link <b><a href="https://mccqueueingsystem.com/login.php/?verification='.$code.'">http://mccqueueingsystem.com/login.php/?verification='.$code.'</a></b>';
