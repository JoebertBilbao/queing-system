...
//for verified email
    ...
    if(isset($_POST['check-email'])){
        ...
        if(mysqli_num_rows($run_sql) > 0){
            ...
            $insert_code = "UPDATE admin SET OTP = $code WHERE email = '$email'";
...
//         $data_check = mysqli_query($con, $insert_data);
    ...
    if(isset($_POST['check-reset-otp'])){
        ...
        $check_code = "SELECT * FROM admin WHERE OTP = $otp_code";
    ...
    if(isset($_POST['change-password'])){
        ...
        if($password !== $cpassword){
            ...
            $update_pass = "UPDATE admin SET OTP = $code, password = '$encpass' WHERE email = '$email'";
