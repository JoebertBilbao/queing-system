...
<head>
    ...
    <title>Admin Login | MCCEA</title>
    <link rel="stylesheet" href="style.css">
    <link href="assets/image/image6.png" rel="icon">
...
<body>
    <div class="container">
        <div class="login form">
            <header>MCCEA OFFICE</header>
            <form action="../action/mccea_login.php" method="post">
