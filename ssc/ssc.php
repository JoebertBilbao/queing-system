...
$sql = "SELECT id, name, email, course, year_level, status, semester, step_status FROM users WHERE step_status = 'step 4'";
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">SSC OFFICE (Step 4)</h1>
                </div>
            </div>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    data: { id: studentId, step: 'step 5' }, // Assuming step 4 is the next step
                    dataType: 'json',
